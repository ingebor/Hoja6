...
public class Main {
	...
	public static void main(final String[] args) throws Exception {
		...
		/**
		 * Se implementa el patron Factory, creando una instancia de la clase MapFactory
		 * y llamando al metodo que devuelve una Map<K, V>, segun los parametros
		...
		while (userOption != 7) {
			...
			System.out.println(
					"1. Agregar una carta a la coleccion. Debe ingresar el nombre de la carta que desea agregar.");
			...
			System.out.println(
					"4. Mostrar el nombre, tipo y cantidad de cada carta en su coleccion, ordenadas por tipo.");
